...
for i in {0,4}
do
python train.py --work_dir ./halfvarmass//100phasedin25kstep_half_varmasspend_4pend_log_true$i --gpu_choice 0 --replay_buffer_capacity 600000 --num_train_steps 600000 --task_name four_poles --eval_freq 4000 --seed $i --time_rev True --domain_name half_varmass_pend --percent_tsym 100 --percent_sampling phase_in --phase_percent 5&
python train.py --work_dir ./halfvarmass/100phasedin25kstep_half_varmasspend_4pend_log_true$((i+1)) --gpu_choice 0 --replay_buffer_capacity 600000 --num_train_steps 600000 --task_name four_poles --eval_freq 4000 --seed $((i+1)) --time_rev True --domain_name half_varmass_pend --percent_tsym 100 --percent_sampling phase_in --phase_percent 5&
python train.py --work_dir ./halfvarmass/100phasedin25kstep_half_varmasspend_4pend_log_true$((i+2)) --gpu_choice 1 --replay_buffer_capacity 600000 --num_train_steps 600000 --task_name four_poles --eval_freq 4000 --seed $((i+2)) --time_rev True --domain_name half_varmass_pend --percent_tsym 100 --percent_sampling phase_in --phase_percent 5&
python train.py --work_dir ./halfvarmass/100phasedin25kstep_half_varmasspend_4pend_log_true$((i+3)) --gpu_choice 1 --replay_buffer_capacity 600000 --num_train_steps 600000 --task_name four_poles --eval_freq 4000 --seed $((i+3)) --time_rev True --domain_name half_varmass_pend --percent_tsym 100 --percent_sampling phase_in --phase_percent 5
...
conda activate aggregate_tb
wait
tb-reducer halfvarmass/100phasedin25kstep_half_varmasspend_4pend_log_true*/tb -o averaged/100phasedin25kstep_half_varmasspend_4pend_log_true/ -r mean,std,min,max --handle-dup-steps 'mean' --lax-steps --lax-tags --overwrite
