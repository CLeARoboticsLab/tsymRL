...
for i in {0..1}
do
python train.py --gpu_choice 4 --work_dir ./log_twopole/false_twopole_swing_pixel_2actionrep_0pt5supdfreq$i --replay_buffer_capacity 1000000 --action_repeat 2 --num_train_steps 1500000 --seed $i --task_name two_poles --encoder_type 'pixel' --decoder_type 'pixel' --eval_freq 10000 --critic_target_update_freq 1 --actor_update_freq 1 --critic_update_freq 1 &
python train.py --gpu_choice 5 --work_dir ./log_twopole/true_twopole_swing_pixel_2actionrep_0pt5supdfreq$i --replay_buffer_capacity 1000000 --action_repeat 2 --num_train_steps 1500000 --time_rev True --seed $i --task_name two_poles --encoder_type 'pixel' --decoder_type 'pixel' --eval_freq 10000 --critic_target_update_freq 1 --actor_update_freq 1 --critic_update_freq 1
wait
done