...
# for i in {0..1}
# do
# python train.py --gpu_choice 3 --work_dir ./log_twopole/false_twopole_swing_2actionrep_w2000xdamp_0pt5supdfreq$i --replay_buffer_capacity 1000000 --action_repeat 2 --num_train_steps 500000 --seed $i --task_name two_poles --eval_freq 10000 --critic_target_update_freq 1 --actor_update_freq 1 --critic_update_freq 1 &
# python train.py --gpu_choice 4 --work_dir ./log_twopole/true_twopole_swing_2actionrep_w2000xdamp_0pt5supdfreq$i --replay_buffer_capacity 1000000 --action_repeat 2 --num_train_steps 500000 --time_rev True --seed $i --task_name two_poles --eval_freq 10000 --critic_target_update_freq 1 --actor_update_freq 1 --critic_update_freq 1
# wait
# done

# for i in {7..8}
# do
# python train.py --gpu_choice 0 --work_dir ./log_twopole/false_twopole_swing_2actionrep_0pt5supdfreq$i --replay_buffer_capacity 2000000 --action_repeat 2 --num_train_steps 1000000 --seed $i --task_name two_poles --eval_freq 10000 --critic_target_update_freq 1 --actor_update_freq 1 --critic_update_freq 1 &
# python train.py --gpu_choice 1 --work_dir ./log_twopole/true_twopole_swing_2actionrep_0pt5supdfreq$i --replay_buffer_capacity 2000000 --action_repeat 2 --num_train_steps 1000000 --time_rev True --seed $i --task_name two_poles --eval_freq 10000 --critic_target_update_freq 1 --actor_update_freq 1 --critic_update_freq 1
# wait
# done

# python train.py --gpu_choice 2 --work_dir ./log_twopole/false_twopole_swing_2actionrep_0pt5supdfreq2 --replay_buffer_capacity 2000000 --action_repeat 2 --num_train_steps 1000000 --seed 2 --task_name two_poles --eval_freq 10000 --critic_target_update_freq 1 --actor_update_freq 1 --critic_update_freq 1 &
# python train.py --gpu_choice 3 --work_dir ./log_twopole/true_twopole_swing_2actionrep_0pt5supdfreq2 --replay_buffer_capacity 2000000 --action_repeat 2 --num_train_steps 1000000 --time_rev True --seed 2 --task_name two_poles --eval_freq 10000 --critic_target_update_freq 1 --actor_update_freq 1 --critic_update_freq 1
# wait

# python train.py --gpu_choice 2 --work_dir ./log_twopole/false_twopole_swing_2actionrep_0pt5supdfreq3 --replay_buffer_capacity 2000000 --action_repeat 2 --num_train_steps 1000000 --seed 3 --task_name two_poles --eval_freq 10000 --critic_target_update_freq 1 --actor_update_freq 1 --critic_update_freq 1 &
# python train.py --gpu_choice 3 --work_dir ./log_twopole/true_twopole_swing_2actionrep_0pt5supdfreq3 --replay_buffer_capacity 2000000 --action_repeat 2 --num_train_steps 1000000 --time_rev True --seed 3 --task_name two_poles --eval_freq 10000 --critic_target_update_freq 1 --actor_update_freq 1 --critic_update_freq 1
# wait
...
# conda activate aggregate_tb
# wait
# tb-reducer log_twopole/false_twopole_swing_2actionrep_0pt5supdfreq*/tb -o averaged/false_twopole_swing_2actionrep_0pt5supdfreq/ -r mean,std,min,max --handle-dup-steps 'mean' --lax-steps --lax-tags --overwrite
# wait
# tb-reducer log_twopole/true_twopole_swing_2actionrep_0pt5supdfreq*/tb -o averaged/true_twopole_swing_2actionrep_0pt5supdfreq/ -r mean,std,min,max --handle-dup-steps 'mean' --lax-steps --lax-tags --overwrite


# for i in {0..3}
# do
# python train.py --gpu_choice 0 --work_dir ./lander_log/false_trial$i --replay_buffer_capacity 300000 --num_train_steps 150000 --seed $i --eval_freq 5000 &
# python train.py --gpu_choice 1 --work_dir ./lander_log/true_trial$i --replay_buffer_capacity 300000 --num_train_steps 150000 --time_rev True --seed $i --eval_freq 5000
# wait
# done

# for i in {4..9}
# do
# python train.py --gpu_choice 0 --work_dir ./test_llog/false_trial$i --replay_buffer_capacity 300000 --num_train_steps 150000 --seed $i --eval_freq 5000 &
# python train.py --gpu_choice 1 --work_dir ./test_llog/true_trial$i --replay_buffer_capacity 300000 --num_train_steps 150000 --time_rev True --seed $i --eval_freq 5000
# wait
# done
...
# conda activate aggregate_tb
# wait
# tb-reducer test_llog/false_trial*/tb -o averaged/lunar_false_trials/ -r mean,std,min,max --handle-dup-steps 'mean' --lax-steps --lax-tags --overwrite
# wait
# tb-reducer test_llog/true_trial*/tb -o averaged/lunar_true_trials/ -r mean,std,min,max --handle-dup-steps 'mean' --lax-steps --lax-tags --overwrite

# for i in {0..2}
# do
# python train.py --gpu_choice 0 --work_dir ./test_llog/false_trial$i --replay_buffer_capacity 300000 --num_train_steps 15001 --seed $i --eval_freq 5000 &
# python train.py --gpu_choice 1 --work_dir ./test_llog/true_trial$i --replay_buffer_capacity 300000 --num_train_steps 15001 --time_rev True --seed $i --eval_freq 5000
# wait
# done

# python train.py --gpu_choice 0 --work_dir ./test_llog/false_trial0 --replay_buffer_capacity 300000 --num_train_steps 15001 --seed 0 --eval_freq 5000 &
# python train.py --gpu_choice 1 --work_dir ./test_llog/true_trial0 --replay_buffer_capacity 300000 --num_train_steps 15001 --time_rev True --seed 0 --eval_freq 5000
...
# # do
# # python train.py --gpu_choice 2 --work_dir ./lunar_log_fixedlogging/false_trial$i --replay_buffer_capacity 400000 --num_train_steps 200000 --seed $i --eval_freq 2000 &
# # python train.py --gpu_choice 3 --work_dir ./lunar_log_fixedlogging/true_trial$i --replay_buffer_capacity 400000 --num_train_steps 200000 --time_rev True --seed $i --eval_freq 2000& 
# # python train.py --gpu_choice 2 --work_dir ./lunar_log_fixedlogging/false_trial$((i+1)) --replay_buffer_capacity 400000 --num_train_steps 200000 --seed $((i+1)) --eval_freq 2000 &
# # python train.py --gpu_choice 3 --work_dir ./lunar_log_fixedlogging/true_trial$((i+1)) --replay_buffer_capacity 400000 --num_train_steps 200000 --time_rev True --seed $((i+1)) --eval_freq 2000
# # wait
# # done
...
# conda activate aggregate_tb
# wait
# tb-reducer temp_lunar_10trial/false_trial*/tb -o averaged/lunar_false_partial/ -r mean,std,min,max --handle-dup-steps 'mean' --lax-steps --lax-tags --overwrite
# wait
# tb-reducer temp_lunar_10trial/true_trial*/tb -o averaged/lunar_true_partial/ -r mean,std,min,max --handle-dup-steps 'mean' --lax-steps --lax-tags --overwrite

# for i in {0,2,4,6,8}
# do
# python train.py --gpu_choice 2 --work_dir ./lunar_removecoll/false_trial$i --replay_buffer_capacity 400000 --num_train_steps 200000 --seed $i --eval_freq 2000 &
# python train.py --gpu_choice 3 --work_dir ./lunar_removecoll/true_trial$i --replay_buffer_capacity 400000 --num_train_steps 200000 --time_rev True --seed $i --eval_freq 2000& 
# python train.py --gpu_choice 2 --work_dir ./lunar_removecoll/false_trial$((i+1)) --replay_buffer_capacity 400000 --num_train_steps 200000 --seed $((i+1)) --eval_freq 2000 &
# python train.py --gpu_choice 3 --work_dir ./lunar_removecoll/true_trial$((i+1)) --replay_buffer_capacity 400000 --num_train_steps 200000 --time_rev True --seed $((i+1)) --eval_freq 2000
# wait
# done
...
# conda activate aggregate_tb
# wait
# tb-reducer lunar_200ktrials/false_trial*/tb -o averaged/lunar_false_200ktrials/ -r mean,std,min,max --handle-dup-steps 'mean' --lax-steps --lax-tags --overwrite
# wait
# tb-reducer lunar_200ktrials/true_trial*/tb -o averaged/lunar_true_200ktrials/ -r mean,std,min,max --handle-dup-steps 'mean' --lax-steps --lax-tags --overwrite


# python train.py --work_dir ./multiact_cartpole_log/1act_dblgear --gpu_choice 1 --replay_buffer_capacity 100000 --num_train_steps 100000 --task_name swingup 
# wait
# python train.py --work_dir ./multiact_cartpole_log/2act_dblgear --gpu_choice 1 --replay_buffer_capacity 600000 --num_train_steps 600000 --task_name two_poles --eval_freq 10000 --save_video


python train.py --work_dir ./multiact_cartpole_log/timesymtrue_disable_slide_pixel_3act_dblgear_2rep_0 --gpu_choice 2 --replay_buffer_capacity 120000 --num_train_steps 600000 --task_name three_poles --eval_freq 10000 --seed 0 --time_rev True --encoder_type 'pixel' --decoder_type 'pixel' --action_repeat 2 &
python train.py --work_dir ./multiact_cartpole_log/timesymfalse_disable_slide_pixel_3act_dblgear_2rep_0 --gpu_choice 3 --replay_buffer_capacity 600000 --num_train_steps 600000 --task_name three_poles --eval_freq 10000 --seed 0 --encoder_type 'pixel' --decoder_type 'pixel' --action_repeat 2  