...
# python train.py --work_dir ./layernorm_cartpole/cartpole_wlayer_log_true0 --gpu_choice 0 --replay_buffer_capacity 100000 --num_train_steps 50000 --task_name swingup --eval_freq 2000 --seed 0 --time_rev True --domain_name "cartpole" &
# python train.py --work_dir ./layernorm_cartpole/cartpole_wlayer_log_true1 --gpu_choice 0 --replay_buffer_capacity 100000 --num_train_steps 50000 --task_name swingup --eval_freq 2000 --seed 1 --time_rev True --domain_name "cartpole" &
# python train.py --work_dir ./layernorm_cartpole/cartpole_wlayer_log_false0 --gpu_choice 1 --replay_buffer_capacity 50000 --num_train_steps 50000 --task_name swingup --eval_freq 2000 --seed 0 --domain_name "cartpole" &
# python train.py --work_dir ./layernorm_cartpole/cartpole_wlayer_log_false1 --gpu_choice 1 --replay_buffer_capacity 50000 --num_train_steps 50000 --task_name swingup --eval_freq 2000 --seed 1 --domain_name "cartpole" &


for i in {2,4,6,8}
do
python train.py --work_dir ./layernorm_cartpole/cartpole_balance_wlayer_log_true$i --gpu_choice 2 --replay_buffer_capacity 100000 --num_train_steps 50000 --task_name balance --eval_freq 2000 --seed $i --time_rev True --domain_name cartpole&
python train.py --work_dir ./layernorm_cartpole/cartpole_balance_wlayer_log_false$i --gpu_choice 2 --replay_buffer_capacity 100000 --num_train_steps 50000 --task_name balance --eval_freq 2000 --seed $i --domain_name cartpole &
python train.py --work_dir ./layernorm_cartpole/cartpole_balance_wlayer_log_true$((i+1)) --gpu_choice 3 --replay_buffer_capacity 50000 --num_train_steps 50000 --task_name balance --eval_freq 2000 --seed $((i+1)) --time_rev True --domain_name cartpole&
python train.py --work_dir ./layernorm_cartpole/cartpole_balance_wlayer_log_false$((i+1)) --gpu_choice 3 --replay_buffer_capacity 50000 --num_train_steps 50000 --task_name balance --eval_freq 2000 --seed $((i+1)) --domain_name cartpole 
wait
done
conda init
eval "$(conda shell.bash hook)"
conda activate aggregate_tb
wait
tb-reducer layernorm_cartpole/cartpole_balance_wlayer_log_true*/tb -o averaged/cartpole_balance_wlayer_log_true/ -r mean,std,min,max --handle-dup-steps 'mean' --lax-steps --lax-tags --overwrite
wait
tb-reducer layernorm_cartpole/cartpole_balance_wlayer_log_false*/tb -o averaged/cartpole_balance_wlayer_log_false/ -r mean,std,min,max --handle-dup-steps 'mean' --lax-steps --lax-tags --overwrite
